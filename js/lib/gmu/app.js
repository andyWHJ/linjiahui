$(function(){
	...
	for(var i in widgets){
		html += '<li><a href="' + i +'"><img src="../../../image/' + widgets[i]['icon'] + '" alt="' + widgets[i]['name'] + '">' +
	...
	demos.imglazyload = [
							{
								...
								file: '../extend/imglazyload/imglazyload_addimg.html.html',
								title: '点击加载图片'
							}
							,{
								file: '../extend/imglazyload/imglazyload_error.html.html',
								title: '图片加载错误处理'
							},{
								file: '../extend/imglazyload/imglazyload_iscroll.html.html',
...
$(function(){
	...
	var updateDemoSection = function(widget){
		...
		demolist.forEach(function(item, index){
			html += '<li><a href="../..//' + item.file + '">' + item.title + '</a></li>';
		});
