...
function Swipe(container, options) {
  ...
  options.continuous = options.continuous ? options.continuous : false;
  function setup() {
    ...
    while(pos--) {
      ...
      slide.setAttribute('data-index.html', pos);
  ...
  var events = {
    ...
    transitionEnd: function(event) {
      ...
      if (parseInt(event.target.getAttribute('data-index.html'), 10) == index) {
  ...
  return {
    ...
    getPos: function() {
      ...
      // return current index.html position
      return index;
