...
$(function() {
	...
	$("#next").bind('click', function(event) {
		window.location.href="page://m.v2/fun=getKeywordNext";
	});
	$("#prev").bind('click', function(event) {
		window.location.href="page://m.v2/fun=getKeywordPrev";		
	});
})
function refreshStoreListData(keyword) {
